...
local ULATEK_COILS_HARD = {
    ...
    slots = {
        slot("coil_a", "Coils Team 1", {
            ...
            compactGroups = true,
            helper = "Use roughly half the raid; this team also maps cleanly to one Phase 2 side.",
        }),
        slot("coil_b", "Coils Team 2", {
            ...
            exclusiveGroup = "coils",
            compactGroups = true,
            helper = "Use roughly half the raid; this team also maps cleanly to the other Phase 2 side.",
        }),
    },
}
