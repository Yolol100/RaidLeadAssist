...
local function calls(coilText, includeSting, includeMythic)
    local result = {
...
Registry:Register({
    ...
    profiles={
        normal={
            ...
            }, calls=calls("SPECTRAL COILS > RAID STACK AT SOAK POINT", false, false),
        },
        heroic={
            explanation={
                ...
                "SPECTRAL COILS: ROTATE SOAK GROUPS; SOUL CONSTRICTOR BLOCKS A REPEAT SOAK.",
            ...
            }, calls=calls("SPECTRAL COILS > NEXT SOAK GROUP IN > ROTATE GROUPS", true, false),
        },
        mythic={
            explanation={
            ...
            }, calls=calls("SPECTRAL COILS > NEXT SOAK GROUP IN > ROTATE GROUPS", true, true),
        },
    },
})
