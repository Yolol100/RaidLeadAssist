    ...
    profiles={
        normal={
            explanation={
                ...
                "THUD TARGETS GO TO THREE SEPARATE SOAK POINTS. DODGE SHELLS. BLINK TARGET GOES EDGE; RAID MOVES AWAY. INTERRUPT ICEBOUND.",
        ...
        heroic={
            explanation={
                ...
                "THUD TARGETS TO THREE SOAK POINTS. DODGE SHELLS. BLINK TARGET EDGE; RAID AWAY. INTERRUPT ICEBOUND.",
        ...
        mythic={
            explanation={
                ...
                "FINAL ASCENSION: FEED AN UNUSED CONTROLLED BOSS. THUD TARGETS USE THREE SOAK POINTS. DODGE SHELLS; INTERRUPT ICEBOUND.",
                "IKU EMPOWER: CLEAR FROST/FIRE WITH OPPOSITE. GEBBO EMPOWER: MOVE OUT FROM BOMBS/WAVES AND SPREADING FLAMES.",
            }, calls=calls(
