...
local function calls(crateAction, crateWarning, includeUnitedDefense)
    local result = {
        ...
        { key="bomb", ability="Explosive Surprise", action="Bomb edge > mushroom over wave", warning="BOMB > EDGE > MUSHROOM OVER WAVE", voice="Bomb edge", spellIDs={1296249}, prepareSeconds=6, pressSeconds=3 },
    }
    ...
    profiles={
        normal={
            explanation={
                ...
                "OPEN GEBBO CRATES UNTIL YOU FIND FISH. RECOMMENDED FISH ORDER: NAMA > IKU > GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE MOR'ZAHI REACHES FULL ENERGY.",
        ...
        heroic={
            explanation={
                ...
                "ROTATE CRATE BREAKERS FOR SPLINTERS. RECOMMENDED FISH ORDER: NAMA > IKU > GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE MOR'ZAHI REACHES FULL ENERGY.",
        ...
        mythic={
            explanation={
                ...
                "ROTATE CRATE BREAKERS FOR SPLINTERS. BEFORE A MYTHIC CRATE BREAK, RAID CLEARS 15+ YARDS. FISH ORDER: NAMA > IKU > GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE FULL ENERGY.",
