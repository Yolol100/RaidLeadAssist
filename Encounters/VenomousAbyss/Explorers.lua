...
local function calls(crateAction, crateWarning, includeUnitedDefense)
    local result = {
        ...
        { key="bomb", ability="Explosive Surprise", action="Bomb edge > mushroom over wave", warning="BOMB > MOVE OUT", voice="Bomb edge", spellIDs={1296249}, prepareSeconds=6, pressSeconds=3 },
    }
    ...
    profiles={
        normal={
            explanation={
                ...
                "OPEN GEBBO CRATES UNTIL YOU FIND FISH. FISH TARGET ORDER: 1 NAMA, 2 IKU, 3 GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE MOR'ZAHI REACHES FULL ENERGY.",
        ...
        heroic={
            explanation={
                ...
                "ROTATE CRATE BREAKERS FOR SPLINTERS. FISH TARGET ORDER: 1 NAMA, 2 IKU, 3 GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE MOR'ZAHI REACHES FULL ENERGY.",
        ...
        mythic={
            explanation={
                "PLAN: BLOODLUST ON PULL. USE THE HEROIC TWO-BOSS SETUP: STACK IKU + GEBBO; KEEP NAMA 30+ YARDS AWAY. KEEP HP EVEN; FINISH TOGETHER.",
                "ROTATE CRATE BREAKERS FOR SPLINTERS. BEFORE A MYTHIC CRATE BREAK, RAID CLEARS 15+ YARDS. FISH TARGET ORDER: 1 NAMA, 2 IKU, 3 GEBBO; FEED THE NEXT UNUSED CONTROLLED BOSS BEFORE FULL ENERGY.",
