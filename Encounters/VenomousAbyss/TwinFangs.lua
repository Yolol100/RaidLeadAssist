...
local adds = {
    ...
    action = "Kill adds; face spit away",
    warning = "Adds: kill them; face spit away.",
    voice = "Adds",
    spellIDs = { 1291404 },
    prepareSeconds = 6,
    pressSeconds = 3,
...
local globules = {
    ...
    action = "One player soak before it bursts",
...
local feastNormal = {
    ...
    action = "Fresh 3+ players soak each hit",
...
local feastFresh = {
    key = "feast",
    ability = "Ravenous Feast",
    action = "Teams A, B, C soak in order",
    warning = "Feast: Team A, then Team B, then Team C.",
    voice = "Feast",
    spellIDs = { 1290516 },
    prepareSeconds = 8,
    pressSeconds = 5,
...
local energy = {
    key = "energy",
    ability = "100 Energy",
    action = "Move to Ithraz; dodge the waves",
    warning = "100 energy: move to Ithraz and dodge the waves.",
        ...
        mythic = {
            ...
            calls = {
                ...
                feastFresh,
                {
                    ...
                    action = "Heal every fount to full",
