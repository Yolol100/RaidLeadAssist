    ...
    return {
        {
            ...
            action = "Take debuffs to the outer markers",
            warning = "Venom: take debuffs to the outer markers.",
            voice = "Venom",
            spellIDs = { 1305959 },
            prepareSeconds = 6,
            pressSeconds = 3,
        },
        {
            ...
            action = "Pair with the opposite arrow",
            warning = "Crosswinds: pair with the opposite arrow.",
            voice = "Crosswinds",
            spellIDs = { 1285425 },
            prepareSeconds = 7,
            pressSeconds = 4,
        ...
        },
        {
            ...
            action = "Called team soaks the green frontal",
            warning = "Mutilate: called team soak the green frontal.",
            voice = "Soak",
        ...
        mythic = {
            ...
            calls = {
                baseCalls()[1], baseCalls()[2], baseCalls()[3], baseCalls()[4],
                {
                    ...
                    action = "14+ stack on the marked player",
                    warning = "Serpent's Fury: 14+ stack on the marked player.",
                    voice = "Stack",
                    timing = false,
                    iconSpellID = 1305621,
                },
