...
local function baseCalls()
    return {
        ...
        { key="apex", ability="Apex Predator", action="Next assigned group soaks green Mutilate", warning="GREEN MUTILATE > NEXT 5+ SOAK GROUP", voice="Soak", spellIDs={1277025,1285430}, prepareSeconds=7, pressSeconds=4 },
    }
end
    ...
    profiles={
        normal={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS DBM-ONLY. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ RAID SOAK GROUPS. BOSS TAKES 30% MORE DAMAGE FOR 25 SEC DURING DIG IN; SAVE DPS COOLDOWNS FOR THIS WINDOW.",
            }, calls=baseCalls(),
        },
        heroic={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS DBM-ONLY. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ RAID SOAK GROUPS: GROUP 1 THEN GROUP 2. REPEAT DAMAGE IS HEAVILY INCREASED; SAVE DPS CDS FOR THE 30% DIG IN WINDOW.",
            }, calls=baseCalls(),
        },
        mythic={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS DBM-ONLY. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ RAID SOAK GROUPS: GROUP 1 THEN GROUP 2. SERPENT'S FURY: 14+ PLAYERS STACK WITHIN 8 YARDS OF THE MARK BEFORE 100 RAGE.",
