    ...
    profiles={
        ...
        heroic={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS DBM-ONLY. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ RAID SOAK GROUPS: GROUP 1 THEN GROUP 2. REPEAT MUTILATE DAMAGE IS HEAVILY INCREASED; SAVE DPS CDS FOR DIG IN.",
            }, calls=baseCalls(),
        },
        mythic={
            explanation={
