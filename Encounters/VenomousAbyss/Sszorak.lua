    ...
    profiles={
        normal={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS BOSSMOD/ROLE-OWNED. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ SOAK TEAMS: TEAM A THEN TEAM B. BOSS TAKES 30% MORE DAMAGE FOR 25 SEC DURING DIG IN; SAVE DPS COOLDOWNS.",
                BOSSMOD_RULE,
            }, calls=baseCalls(),
        },
        heroic={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS BOSSMOD/ROLE-OWNED. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ SOAK TEAMS: TEAM A THEN TEAM B. REPEAT DAMAGE IS HEAVILY INCREASED; SAVE DPS CDS FOR THE 30% DIG IN WINDOW.",
                BOSSMOD_RULE,
            }, calls=baseCalls(),
        },
        mythic={
            explanation={
                ...
                "APEX: WHITE RAVAGE IS BOSSMOD/ROLE-OWNED. GREEN MUTILATE ALTERNATES TWO DISTINCT 5+ SOAK TEAMS: TEAM A THEN TEAM B. SERPENT'S FURY: 14+ PLAYERS STACK WITHIN 8 YARDS OF THE MARK BEFORE 100 RAGE.",
