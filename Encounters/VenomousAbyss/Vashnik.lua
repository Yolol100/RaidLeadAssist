...
local catalyst = timedCall("catalyst", "Malignant Catalyst", "BILE > SOAK TEAM", "Bile soak team", { 1282525, 1282509 }, 7, 4)
...
Registry:Register({
    ...
    encounterID = 3455,
    strategyStatus = "12.1 Journal + current Wowhead/Raidstrats + DBM/BigWigs source-reviewed 2026-08-18; raidlead-only call scope; live validation pending",
    profiles = {
        normal = {
            explanation = {
        ...
        heroic = {
            explanation = {
                ...
                "SOAK EVERY CATALYTIC BILE. BLOOD: STACK HELPERS FOR SIPHON. FROTH TARGETS MOVE OUT AND AIM WAVES AWAY.",
                "EXPLODING INFECTION GOES FAR OUT. STYGIAN INFECTION SPREADS AND KEEPS MOVING; SHADOW PLAYERS DODGE THEIR SWIRLIES.",
                BOSSMOD_RULE,
            },
            calls = heroicCalls(),
        },
        mythic = {
            explanation = {
                "BLOODLUST ON PULL. USE THE HEROIC ROUTE AND FIRE STAGGER. KILL LIVING VENOMS BEFORE CENTER AND SOAK EVERY BILE.",
                "FROTH TARGETS AIM PLAGUE WAVES THROUGH TUMORS TO REMOVE HARDENED TUMOR, THEN KILL THE EXPOSED TUMORS.",
                "BLOOD: STACK HELPERS ON SIPHON TARGETS. EXPLODING INFECTION GOES FAR OUT; STYGIAN INFECTION SPREADS AND KEEPS MOVING.",
                "SHADOW PLAYERS DODGE THEIR SWIRLIES. MYTHIC MALIGNANCE MAKES REPEATED INFECTION MISTAKES MORE DANGEROUS.",
                BOSSMOD_RULE,
            },
            calls = mythicCalls(),
        },
