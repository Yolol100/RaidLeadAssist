...
for _, difficulty in ipairs(difficulties) do
    ...
    assert(not contains(plan("sentinels", difficulty), "TANK"), "Sentinels raid plan must remain tank-call free")
end
...
print("ok - boss 1/2 use raidleader-only calls with source-backed timer identities and difficulty scope")
