...
assert(warning == "After Stasis: Group 1 green; Group 2 red; tanks swap bosses.")
local action = Assignments:BuildCallAction(call.action, "sentinels", "heroic", "side_swap")
assert(action == "Group 1 green; Group 2 red; tanks swap bosses")
...
local plan = table.concat(Encounters:GetProfile("sentinels", "normal").explanation, "\n")
assert(plan:find("heal the weaker boss", 1, true), "Stasis plan must preserve the weaker-boss healing instruction")
print("ok - Sentinels calls render configured physical sides and the tank swap")
