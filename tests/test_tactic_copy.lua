...
assert(contains(planText("explorers", "normal"), "FINISH TOGETHER"))
assert(contains(planText("explorers", "heroic"), "UNITED DEFENSE"))
assert(contains(planText("explorers", "mythic"), "UNITED DEFENSE"))
assert(contains(planText("explorers", "heroic"), "DIE TOGETHER"))
assert(contains(planText("explorers", "mythic"), "DIE TOGETHER"))
...
for _, difficultyKey in ipairs(Constants.DIFFICULTY_ORDER) do
    ...
    assert(contains(twin.callsByKey.balance.warning, "FINISH TOGETHER"))
    assert(contains(planText("twinfangs", difficultyKey), "FINISH BOTH BOSSES TOGETHER"))
...
assert(not contains(ulatekHeroic.callsByKey.coils.warning, "ROTATE"))
