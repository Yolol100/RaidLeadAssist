...
assert(contains(plan("heroic"), "REPEAT DAMAGE IS HEAVILY INCREASED"))
...
print("ok - Sszorak raidlead plan, green Mutilate soak and DBM/BigWigs timer identities stay aligned")
